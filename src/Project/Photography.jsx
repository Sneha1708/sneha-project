...
const Photography = () => {
  ...
  const equipment = ["Canon EOS R5", "Sigma Art Lenses", "DJI Mavic Air 2"];
  return (
    <div>
      <FreelancerDetails
        name="Ganesh"
        ...
        biography={
          <div className="bio-container">
            ...
            <p>
              Greetings! I'm Ganesh, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
            <p>
              🌟 Specialties:
              <ul>
            ...
            <img
              src="https://cdn.pixabay.com/photo/2023/10/18/10/28/bird-8323639_640.jpg"
              alt=""
            ></img>
            <img
              style={{ height: "430px", width: "300px" }}
              src="https://cdn.pixabay.com/photo/2023/11/14/15/38/butterfly-8387990_640.jpg"
              alt=""
            ></img>
            <img
              style={{ height: "750px", width: "480px" }}
              src="https://cdn.pixabay.com/photo/2023/11/04/04/45/woman-8364265_1280.jpg"
              alt=""
            ></img>
            <img
              style={{ height: "750px", width: "480px" }}
              src="https://cdn.pixabay.com/photo/2021/09/06/05/55/love-6600903_1280.jpg"
              alt=""
            ></img>
            <p>
              📷 Equipment:
            ...
            <p>
              💡 My goal is to capture the essence of every moment, whether it's
              a heartfelt portrait, a stunning landscape, or the excitement of a
              special event. I believe in the power of visual storytelling, and
              I'm here to bring your ideas to life through my lens.
            </p>
            <div className="contact-info">
              ...
              📱 Phone: 93774723677
              <br />
              📍 Based in: Kuniyamuthur,Coimbatore
            </div>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Sophia Sen, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Sowmiya, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Ram, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Cathrine, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Karthick, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Sowbiya, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Yukesh, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Anita, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
      ...
      <FreelancerDetails
        ...
        biography={
          <div className="bio-container">
            <h2>📸 Capturing Moments, Creating Memories 📸</h2>
            <p>
              Greetings! I'm Guru, a passionate photographer dedicated to
              freezing moments in time and turning them into everlasting
              memories. With an eye for detail and a love for creativity, I
              specialize in various photography styles.
            </p>
